...
export default function CourseClient({ id }: { id: string }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--c-bg)" }}>
      ...
      <div
        style={{ maxWidth: 1280, margin: "0 auto", padding: "72px 20px 48px" }}
      >
        {/* Breadcrumb */}
        <div
          style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  ...
                  style={{
                    ...
                    cursor:
                      activeIdx === c.lessons.length - 1
                        ...
                        : "pointer",
                    color: "var(--c-ink2)",
                    opacity: activeIdx === c.lessons.length - 1 ? 0.4 : 1,
                  }}
                >
                  next →
                </button>
            ...
            <div>
              ...
              >
                ...
                >
                  {completed.length}/{c.lessons.length} completed
                </span>
                <span
                  style={{
                    fontSize: 11,
              ...
              <div className="progress-track">
                <div
                  ...
                  style={{ width: `${progress}%`, background: a.bar }}
                />
              </div>
            </div>
            ...
            {activeLesson.youtubeId && (
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                >
                  Know a better video for this topic?
                </span>
              </div>
            )}
          </div>
              ...
              <div style={{ padding: "14px 16px" }}>
                ...
                >
                  ...
                  <span
                    style={{ display: "flex", alignItems: "center", gap: 4 }}
                  >
                    <BookOpen size={10} /> {c.totalLessons}
                  </span>
                  <span
                    style={{ display: "flex", alignItems: "center", gap: 4 }}
                  >
                    <Users size={10} /> {c.students.toLocaleString()}
                  </span>
                  <span
                    style={{ display: "flex", alignItems: "center", gap: 4 }}
                  >
                ...
                {TABS.map((t) => (
                  <button
                    ...
                    style={{
                      ...
                      background: "none",
                      border: "none",
                      borderBottom: `2px solid ${sideTab === t.id ? a.bar : "transparent"}`,
                      color: sideTab === t.id ? a.bar : "var(--c-ink3)",
